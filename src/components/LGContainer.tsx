...
glassCard: { flex: 1, width: '100%', height: '100%', borderRadius: 0, overflow: 'hidden', borderWidth: 0, backgroundColor: 'hsl(178, 100%, 95%)' },  liquidContainer: { position: 'absolute', bottom: 0, left: 0, right: 0, overflow: 'hidden' },
